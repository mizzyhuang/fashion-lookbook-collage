...
```text
Use $skill-installer to install https://github.com/<your-github-handle>/fashion-lookbook-collage
```
...
```text
使用 $skill-installer 安装 https://github.com/<你的 GitHub 用户名>/fashion-lookbook-collage
```
